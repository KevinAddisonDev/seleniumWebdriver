...
public class WebDriverBasicLocatorsWithCssSelectorTest extends AbstractWebDriverTest {

	
  @Test
  public void testCssSelectorForTableRow1() {
  ...
  public void testSortedBrowserRow1() {
	  
	  driver.get("http://localhost:8080/pages/tables.html");
	  WebElement tableBrowserColumnElement = driver.findElement(By.cssSelector("#dataTables-example > thead > tr > th:nth-child(2)"));
	  tableBrowserColumnElement.click();
	  WebElement tableBrowserColumnRow1 = driver.findElement(By.cssSelector("#dataTables-example > tbody > tr.gradeU.odd > td.sorting_1"));
